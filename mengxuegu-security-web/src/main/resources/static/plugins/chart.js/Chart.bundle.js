	...
	calculateBarValuePixels: function(datasetIndex, index) {
		...
		if (stacked || (stacked === undefined && stack !== undefined)) {
			for (i = 0; i < datasetIndex; ++i) {
				...
				if (imeta.bar &&
					imeta.stack === stack &&
					com.mengxuegu.web.controller._getValueScaleId() === scale.id &&
		...
		if (!arcs) {
			...
			for (i = 0, ilen = chart.data.datasets.length; i < ilen; ++i) {
				if (chart.isDatasetVisible(i)) {
					...
					arcs = meta.data;
					if (i !== me.index) {
						controller = com.mengxuegu.web.controller;
					}
					break;
				}
			}
...
function createTooltipItem(element) {
	...
	var controller = com.mengxuegu.web.controller;
...
helpers$1.extend(Chart.prototype, /** @lends Chart */ {
	...
	resetElements: function() {
		var me = this;
		helpers$1.each(me.data.datasets, function(dataset, datasetIndex) {
			com.mengxuegu.web.controller.reset();
		}, me);
	},
	...
	*/
	...
	update: function(config) {
		...
		helpers$1.each(me.data.datasets, function(dataset, datasetIndex) {
			com.mengxuegu.web.controller.buildOrUpdateElements();
		}, me);
	...
	updateDataset: function(index) {
		...
		com.mengxuegu.web.controller.update();
	...
	transition: function(easingValue) {
		...
		for (var i = 0, ilen = (me.data.datasets || []).length; i < ilen; ++i) {
			if (me.isDatasetVisible(i)) {
				com.mengxuegu.web.controller.transition(easingValue);
			}
		}
	...
	drawDataset: function(index, easingValue) {
		...
		com.mengxuegu.web.controller.draw(easingValue);
	...
	destroyDatasetMeta: function(datasetIndex) {
		...
		if (meta) {
			com.mengxuegu.web.controller.destroy();
	...
	updateHoverStyle: function(elements, mode, enabled) {
		...
		for (i = 0, ilen = elements.length; i < ilen; ++i) {
			element = elements[i];
			if (element) {
				com.mengxuegu.web.controller[method](element);
			}
		}
	},
...
var scale_category = core_scale.extend({
	...
	*/
	...
	getLabelForIndex: function(index, datasetIndex) {
		...
		if (com.mengxuegu.web.controller._getValueScaleId() === me.id) {
